...
sleep 3
Write-Output " "
Mount-HPEiLOVirtualMedia -Connection $connection -Device CD -ImageURL http://10.10.124.10/P35938_001_spp-2021.05.0-SPP2021050.2021_0504.129.iso
...
Write-Output "This should be plenty of time for the SPP to update  "
sleep 1500
